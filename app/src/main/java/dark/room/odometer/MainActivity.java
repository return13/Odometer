            ...
            case PERMISSION_REQUEST_CODE:{
                if (grantResults.length>0 && grantResults[0]==PackageManager.PERMISSION_GRANTED){
                    ...
                    NotificationCompat.Builder builder=new NotificationCompat.Builder(this)
                            ...
                            .setAutoCancel(true);
                    //Создание действия
                    Intent actionIntenet=new Intent(this, MainActivity.class);
                    PendingIntent actionPendingIntent=PendingIntent.getActivity(this, 0, actionIntenet, PendingIntent.FLAG_UPDATE_CURRENT);
